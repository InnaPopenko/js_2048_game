...
class Game {
  ...
  rotateCounterClockwise(board) {
    ...
    for (let rolSecond = 0; rolSecond < this.size; rolSecond++) {
      for (let colSecond = 0; colSecond < this.size; colSecond++) {
        newBoard[this.size - 1 - colSecond][rolSecond] =
          board[rolSecond][colSecond];
      }
    }
